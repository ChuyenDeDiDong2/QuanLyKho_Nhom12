...
public class ModelUser {
    ...
    public ModelUser(String uid, String name, String phone, String email, String sotaikhoan, String tentaikhoan, String diachi, String tinhthanh, String accountType, String online, String open, String noibat, String profileImage, String typingTo) {
        this.uid = uid;
        this.name = name;
        this.phone = phone;
        this.email = email;
